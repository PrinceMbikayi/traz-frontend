...
const AuthScreen = ({ navigation }) => {
  ...
  const handleRegister = async () => {
    if (!isChecked) {
      Alert.alert('Termes et Conditions', "Vous devez accepter les termes et conditions pour vous inscrire.");
      return;
    }
    ...
    try {
      ...
      if (response.status === 201) {
        ...
        if (user){
          ...
          Alert.alert('Erreur', "Les informations utilisateur sont manquantes.");
          return;
        }
      ...
      <View style={{ flex: 1, marginVertical: 5 }}>
        ...
        <TouchableOpacity onPress={pickImage}>
          <Image 
           ...
           style={{ width: 100, height: 100, borderRadius: 50, marginLeft: 160, marginBottom: 10, marginTop: 5, }} 
          />
        </TouchableOpacity>
        ...
        <View style={{
          ...
          <Text style={{ fontSize: 16, color: COLORS.black}}>Déjà un compte?</Text>
          <Pressable
